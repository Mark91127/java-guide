...
* [Ch5. 物件](#ch5-物件)
  * [物件 (Object)](#物件-object)
    * [實例化 (Instantiation)](#實例化-instantiation)
    * [堆(Heap) vs 堆疊(Stack)](#堆heap-vs-堆疊stack)
      * [堆疊(Stack)](#堆疊stack)
      * [堆(Heap)](#堆heap)
      * [物件導向概念 - 參照 (Reference)](#物件導向概念---參照-reference)
    * [垃圾回收機制 (Garbage Collection , GC)](#垃圾回收機制-garbage-collection--gc)
  * [重點整理](#重點整理)
<!-- TOC -->
